...
class AudioServer(Process):
    def __init__(self, udp_ip='localhost', udp_port_rec=10000, udp_port_send=10001, datasize=2048, frate=44100):
    ...
    def run(self):
        ...
        if self.server.connected:
            ...
            beat_detectors = [BeatDetect(wait=0.2, threshold=20, history=history_length) for x in xrange(7)]
